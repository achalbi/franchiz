class UserMailer < ApplicationMailer
    ...
    def welcome_email(business, inquiry)
        ...
        @business = business
        @inquiry = inquiry
        @url  = "#{request.base_url}/inquiries/"+inquiry.id.to_s
    ...
    def survey_user_input_email(inquiry)
        ...
        @inquiry = inquiry
        @url  = "#{request.base_url}/surveys/"+inquiry.survey.id.to_s+"/survey_user_answers"
     #   email_with_name = %("#{@user.name}" <#{@user.email}>)
        email = @user.email
    ...
    def survey_biz_review_email(inquiry)
        @business = inquiry.business
        @inquiry = inquiry
        @url  = "#{request.base_url}/businesses/"+@business.id.to_s+"/inquiries/"+inquiry.id.to_s+"/surveys/"+inquiry.survey.id.to_s+"/"

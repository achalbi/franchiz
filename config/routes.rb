...
#                          survey_item_category_templates GET    /survey_item_category_templates(.:format)                                                                  survey_item_category_templates#index
#                                                         POST   /survey_item_category_templates(.:format)                                                                  survey_item_category_templates#create
#                       new_survey_item_category_template GET    /survey_item_category_templates/new(.:format)                                                              survey_item_category_templates#new
#                      edit_survey_item_category_template GET    /survey_item_category_templates/:id/edit(.:format)                                                         survey_item_category_templates#edit
#                           survey_item_category_template GET    /survey_item_category_templates/:id(.:format)                                                              survey_item_category_templates#show
#                                                         PATCH  /survey_item_category_templates/:id(.:format)                                                              survey_item_category_templates#update
#                                                         PUT    /survey_item_category_templates/:id(.:format)                                                              survey_item_category_templates#update
#                                                         DELETE /survey_item_category_templates/:id(.:format)                                                              survey_item_category_templates#destroy
...
#                                     survey_user_answers GET    /survey_user_answers(.:format)                                                                             survey_user_answers#index
#                                                         POST   /survey_user_answers(.:format)                                                                             survey_user_answers#create
#                                  new_survey_user_answer GET    /survey_user_answers/new(.:format)                                                                         survey_user_answers#new
#                                 edit_survey_user_answer GET    /survey_user_answers/:id/edit(.:format)                                                                    survey_user_answers#edit
#                                      survey_user_answer GET    /survey_user_answers/:id(.:format)                                                                         survey_user_answers#show
#                                                         PATCH  /survey_user_answers/:id(.:format)                                                                         survey_user_answers#update
#                                                         PUT    /survey_user_answers/:id(.:format)                                                                         survey_user_answers#update
#                                                         DELETE /survey_user_answers/:id(.:format)                                                                         survey_user_answers#destroy
#                                 survey_biz_user_answers GET    /survey_biz_user_answers(.:format)                                                                         survey_biz_user_answers#index
#                                                         POST   /survey_biz_user_answers(.:format)                                                                         survey_biz_user_answers#create
#                              new_survey_biz_user_answer GET    /survey_biz_user_answers/new(.:format)                                                                     survey_biz_user_answers#new
#                             edit_survey_biz_user_answer GET    /survey_biz_user_answers/:id/edit(.:format)                                                                survey_biz_user_answers#edit
#                                  survey_biz_user_answer GET    /survey_biz_user_answers/:id(.:format)                                                                     survey_biz_user_answers#show
#                                                         PATCH  /survey_biz_user_answers/:id(.:format)                                                                     survey_biz_user_answers#update
#                                                         PUT    /survey_biz_user_answers/:id(.:format)                                                                     survey_biz_user_answers#update
#                                                         DELETE /survey_biz_user_answers/:id(.:format)                                                                     survey_biz_user_answers#destroy
#                                      status_survey_item PATCH  /survey_items/:id/status(.:format)                                                                         survey_items#status
#                                    survey_item_comments GET    /survey_items/:survey_item_id/comments(.:format)                                                           comments#index
#                                                         POST   /survey_items/:survey_item_id/comments(.:format)                                                           comments#create
#                                 new_survey_item_comment GET    /survey_items/:survey_item_id/comments/new(.:format)                                                       comments#new
#                                edit_survey_item_comment GET    /survey_items/:survey_item_id/comments/:id/edit(.:format)                                                  comments#edit
#                                     survey_item_comment GET    /survey_items/:survey_item_id/comments/:id(.:format)                                                       comments#show
#                                                         PATCH  /survey_items/:survey_item_id/comments/:id(.:format)                                                       comments#update
#                                                         PUT    /survey_items/:survey_item_id/comments/:id(.:format)                                                       comments#update
#                                                         DELETE /survey_items/:survey_item_id/comments/:id(.:format)                                                       comments#destroy
#                                                         GET    /survey_items(.:format)                                                                                    survey_items#index
#                                                         POST   /survey_items(.:format)                                                                                    survey_items#create
#                                                         GET    /survey_items/new(.:format)                                                                                survey_items#new
#                                                         GET    /survey_items/:id/edit(.:format)                                                                           survey_items#edit
#                                                         GET    /survey_items/:id(.:format)                                                                                survey_items#show
#                                                         PATCH  /survey_items/:id(.:format)                                                                                survey_items#update
#                                                         PUT    /survey_items/:id(.:format)                                                                                survey_items#update
#                                                         DELETE /survey_items/:id(.:format)                                                                                survey_items#destroy
#                              survey_survey_user_answers GET    /surveys/:survey_id/survey_user_answers(.:format)                                                          survey_user_answers#index
#                                                         POST   /surveys/:survey_id/survey_user_answers(.:format)                                                          survey_user_answers#create
#                           new_survey_survey_user_answer GET    /surveys/:survey_id/survey_user_answers/new(.:format)                                                      survey_user_answers#new
#                          edit_survey_survey_user_answer GET    /surveys/:survey_id/survey_user_answers/:id/edit(.:format)                                                 survey_user_answers#edit
#                               survey_survey_user_answer GET    /surveys/:survey_id/survey_user_answers/:id(.:format)                                                      survey_user_answers#show
#                                                         PATCH  /surveys/:survey_id/survey_user_answers/:id(.:format)                                                      survey_user_answers#update
#                                                         PUT    /surveys/:survey_id/survey_user_answers/:id(.:format)                                                      survey_user_answers#update
#                                                         DELETE /surveys/:survey_id/survey_user_answers/:id(.:format)                                                      survey_user_answers#destroy
#                          survey_survey_biz_user_answers GET    /surveys/:survey_id/survey_biz_user_answers(.:format)                                                      survey_biz_user_answers#index
#                                                         POST   /surveys/:survey_id/survey_biz_user_answers(.:format)                                                      survey_biz_user_answers#create
#                       new_survey_survey_biz_user_answer GET    /surveys/:survey_id/survey_biz_user_answers/new(.:format)                                                  survey_biz_user_answers#new
#                      edit_survey_survey_biz_user_answer GET    /surveys/:survey_id/survey_biz_user_answers/:id/edit(.:format)                                             survey_biz_user_answers#edit
#                           survey_survey_biz_user_answer GET    /surveys/:survey_id/survey_biz_user_answers/:id(.:format)                                                  survey_biz_user_answers#show
#                                                         PATCH  /surveys/:survey_id/survey_biz_user_answers/:id(.:format)                                                  survey_biz_user_answers#update
#                                                         PUT    /surveys/:survey_id/survey_biz_user_answers/:id(.:format)                                                  survey_biz_user_answers#update
#                                                         DELETE /surveys/:survey_id/survey_biz_user_answers/:id(.:format)                                                  survey_biz_user_answers#destroy
#                                   franchiz_input_survey GET    /surveys/:id/franchiz_input(.:format)                                                                      surveys#franchiz_input
...
#                                                         PUT    /systems/:id(.:format)                                                                                     systems#update
#                                                         DELETE /systems/:id(.:format)                                                                                     systems#destroy
#     survey_item_category_template_survey_item_templates GET    /survey_item_category_templates/:survey_item_category_template_id/survey_item_templates(.:format)          survey_item_templates#index
#                                                         POST   /survey_item_category_templates/:survey_item_category_template_id/survey_item_templates(.:format)          survey_item_templates#create
#  new_survey_item_category_template_survey_item_template GET    /survey_item_category_templates/:survey_item_category_template_id/survey_item_templates/new(.:format)      survey_item_templates#new
# edit_survey_item_category_template_survey_item_template GET    /survey_item_category_templates/:survey_item_category_template_id/survey_item_templates/:id/edit(.:format) survey_item_templates#edit
#      survey_item_category_template_survey_item_template GET    /survey_item_category_templates/:survey_item_category_template_id/survey_item_templates/:id(.:format)      survey_item_templates#show
#                                                         PATCH  /survey_item_category_templates/:survey_item_category_template_id/survey_item_templates/:id(.:format)      survey_item_templates#update
#                                                         PUT    /survey_item_category_templates/:survey_item_category_template_id/survey_item_templates/:id(.:format)      survey_item_templates#update
#                                                         DELETE /survey_item_category_templates/:survey_item_category_template_id/survey_item_templates/:id(.:format)      survey_item_templates#destroy
#                                                         GET    /survey_item_category_templates(.:format)                                                                  survey_item_category_templates#index
#                                                         POST   /survey_item_category_templates(.:format)                                                                  survey_item_category_templates#create
#                                                         GET    /survey_item_category_templates/new(.:format)                                                              survey_item_category_templates#new
#                                                         GET    /survey_item_category_templates/:id/edit(.:format)                                                         survey_item_category_templates#edit
#                                                         GET    /survey_item_category_templates/:id(.:format)                                                              survey_item_category_templates#show
#                                                         PATCH  /survey_item_category_templates/:id(.:format)                                                              survey_item_category_templates#update
#                                                         PUT    /survey_item_category_templates/:id(.:format)                                                              survey_item_category_templates#update
#                                                         DELETE /survey_item_category_templates/:id(.:format)                                                              survey_item_category_templates#destroy
#                       survey_item_category_survey_items GET    /survey_item_categories/:survey_item_category_id/survey_items(.:format)                                    survey_items#index
#                                                         POST   /survey_item_categories/:survey_item_category_id/survey_items(.:format)                                    survey_items#create
#                    new_survey_item_category_survey_item GET    /survey_item_categories/:survey_item_category_id/survey_items/new(.:format)                                survey_items#new
#                   edit_survey_item_category_survey_item GET    /survey_item_categories/:survey_item_category_id/survey_items/:id/edit(.:format)                           survey_items#edit
#                        survey_item_category_survey_item GET    /survey_item_categories/:survey_item_category_id/survey_items/:id(.:format)                                survey_items#show
#                                                         PATCH  /survey_item_categories/:survey_item_category_id/survey_items/:id(.:format)                                survey_items#update
#                                                         PUT    /survey_item_categories/:survey_item_category_id/survey_items/:id(.:format)                                survey_items#update
#                                                         DELETE /survey_item_categories/:survey_item_category_id/survey_items/:id(.:format)                                survey_items#destroy
#                                                         GET    /survey_item_categories(.:format)                                                                          survey_item_categories#index
#                                                         POST   /survey_item_categories(.:format)                                                                          survey_item_categories#create
#                                                         GET    /survey_item_categories/new(.:format)                                                                      survey_item_categories#new
#                                                         GET    /survey_item_categories/:id/edit(.:format)                                                                 survey_item_categories#edit
#                                                         GET    /survey_item_categories/:id(.:format)                                                                      survey_item_categories#show
#                                                         PATCH  /survey_item_categories/:id(.:format)                                                                      survey_item_categories#update
#                                                         PUT    /survey_item_categories/:id(.:format)                                                                      survey_item_categories#update
#                                                         DELETE /survey_item_categories/:id(.:format)                                                                      survey_item_categories#destroy
#          survey_template_survey_item_category_templates GET    /survey_templates/:survey_template_id/survey_item_category_templates(.:format)                             survey_item_category_templates#index
#                                                         POST   /survey_templates/:survey_template_id/survey_item_category_templates(.:format)                             survey_item_category_templates#create
#       new_survey_template_survey_item_category_template GET    /survey_templates/:survey_template_id/survey_item_category_templates/new(.:format)                         survey_item_category_templates#new
#      edit_survey_template_survey_item_category_template GET    /survey_templates/:survey_template_id/survey_item_category_templates/:id/edit(.:format)                    survey_item_category_templates#edit
#           survey_template_survey_item_category_template GET    /survey_templates/:survey_template_id/survey_item_category_templates/:id(.:format)                         survey_item_category_templates#show
#                                                         PATCH  /survey_templates/:survey_template_id/survey_item_category_templates/:id(.:format)                         survey_item_category_templates#update
#                                                         PUT    /survey_templates/:survey_template_id/survey_item_category_templates/:id(.:format)                         survey_item_category_templates#update
#                                                         DELETE /survey_templates/:survey_template_id/survey_item_category_templates/:id(.:format)                         survey_item_category_templates#destroy
...
#                                  import_survey_template GET    /import_survey_templates/:id(.:format)                                                                     import_survey_templates#show
...
#                                          import_surveys GET    /import_surveys(.:format)                                                                                  import_surveys#index
#                                                         POST   /import_surveys(.:format)                                                                                  import_surveys#create
#                                       new_import_survey GET    /import_surveys/new(.:format)                                                                              import_surveys#new
#                                      edit_import_survey GET    /import_surveys/:id/edit(.:format)                                                                         import_surveys#edit
#                                           import_survey GET    /import_surveys/:id(.:format)                                                                              import_surveys#show
...
#                                                         PUT    /businesses/:id(.:format)                                                                                  businesses#update
#                                                         DELETE /businesses/:id(.:format)                                                                                  businesses#destroy
#                                         inquiry_surveys GET    /inquiries/:inquiry_id/surveys(.:format)                                                                   surveys#index
#                                                         POST   /inquiries/:inquiry_id/surveys(.:format)                                                                   surveys#create
#                                      new_inquiry_survey GET    /inquiries/:inquiry_id/surveys/new(.:format)                                                               surveys#new
#                                     edit_inquiry_survey GET    /inquiries/:inquiry_id/surveys/:id/edit(.:format)                                                          surveys#edit
#                                          inquiry_survey GET    /inquiries/:inquiry_id/surveys/:id(.:format)                                                               surveys#show
#                                                         PATCH  /inquiries/:inquiry_id/surveys/:id(.:format)                                                               surveys#update
#                                                         PUT    /inquiries/:inquiry_id/surveys/:id(.:format)                                                               surveys#update
#                                                         DELETE /inquiries/:inquiry_id/surveys/:id(.:format)                                                               surveys#destroy
...
#                                  inquiry_import_surveys GET    /inquiries/:inquiry_id/import_surveys(.:format)                                                            import_surveys#index
#                                                         POST   /inquiries/:inquiry_id/import_surveys(.:format)                                                            import_surveys#create
#                               new_inquiry_import_survey GET    /inquiries/:inquiry_id/import_surveys/new(.:format)                                                        import_surveys#new
#                              edit_inquiry_import_survey GET    /inquiries/:inquiry_id/import_surveys/:id/edit(.:format)                                                   import_surveys#edit
#                                   inquiry_import_survey GET    /inquiries/:inquiry_id/import_surveys/:id(.:format)                                                        import_surveys#show
#                                                         PATCH  /inquiries/:inquiry_id/import_surveys/:id(.:format)                                                        import_surveys#update
#                                                         PUT    /inquiries/:inquiry_id/import_surveys/:id(.:format)                                                        import_surveys#update
#                                                         DELETE /inquiries/:inquiry_id/import_surveys/:id(.:format)                                                        import_surveys#destroy
...
#  resource :business
  ...
  post 'inquiry_filters/view' => 'inquiry_filters#view'
  get 'inquiry_filters/index' => 'inquiry_filters#index'

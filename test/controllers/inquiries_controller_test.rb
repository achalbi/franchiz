...
class InquiriesControllerTest < ActionController::TestCase
  ...
  test "should create inquiry" do
    assert_difference('Inquiry.count') do
      post :create, inquiry: { business_id: @inquiry.business_id, token: @inquiry.token, user_id: @inquiry.user_id }
    end
  ...
  test "should update inquiry" do
    patch :update, id: @inquiry, inquiry: { business_id: @inquiry.business_id, token: @inquiry.token, user_id: @inquiry.user_id }
    assert_redirected_to inquiry_path(assigns(:inquiry))
  end

...
class SurveyTemplatesControllerTest < ActionController::TestCase
  ...
  test "should create survey_template" do
    assert_difference('SurveyTemplate.count') do
      post :create, survey_template: { description: @survey_template.description, surveyable_id: @survey_template.surveyable_id, surveyable_type: @survey_template.surveyable_type, title: @survey_template.title }
    end
  ...
  test "should update survey_template" do
    patch :update, id: @survey_template, survey_template: { description: @survey_template.description, surveyable_id: @survey_template.surveyable_id, surveyable_type: @survey_template.surveyable_type, title: @survey_template.title }
    assert_redirected_to survey_template_path(assigns(:survey_template))
  end
